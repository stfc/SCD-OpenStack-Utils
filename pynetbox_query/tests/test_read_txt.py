...
def test_read(mock_dict_to_dataclass, mock_list, mock_dict_reader, mock_open, mock_check_file_path):
    ...
    mock_dict_reader.assert_called_once_with(mock_open.return_value.__enter__.return_value, delimiter=",")
